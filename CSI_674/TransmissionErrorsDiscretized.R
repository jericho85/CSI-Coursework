...
# Triplot shows prior, normalized likelihood and posterior (p. 2-52)
...
#Process observations sequentially and do a triplot at each step (p 2-54)
...
#Process observations sequentially and predict next observation at 
# each step (p. 2-57)
