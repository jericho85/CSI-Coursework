...
cred_int <- qbeta(c(0.025,0.975),shape1=Beta_posterior[1],shape2=Beta_posterior[2])

print(paste0("Posterior Mean:  ",posterior_mean))
print(paste0("Posterior Standard Deviation:  ",posterior_sd))
